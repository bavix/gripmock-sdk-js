...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GripmockSdk.ServicesApi();
  });
  ...
  describe('ServicesApi', function() {
    describe('serviceMethodsList', function() {
      it('should call serviceMethodsList successfully', function(done) {
        //uncomment below and update the code to test serviceMethodsList
        //instance.serviceMethodsList(function(error) {
