...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GripmockSdk.McpInfoResponse();
  });
  ...
  describe('McpInfoResponse', function() {
    it('should create an instance of McpInfoResponse', function() {
      // uncomment below and update the code to test McpInfoResponse
      //var instance = new GripmockSdk.McpInfoResponse();
      //expect(instance).to.be.a(GripmockSdk.McpInfoResponse);
    });
