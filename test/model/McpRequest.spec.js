...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GripmockSdk.McpRequest();
  });
  ...
  describe('McpRequest', function() {
    it('should create an instance of McpRequest', function() {
      // uncomment below and update the code to test McpRequest
      //var instance = new GripmockSdk.McpRequest();
      //expect(instance).to.be.a(GripmockSdk.McpRequest);
    });
