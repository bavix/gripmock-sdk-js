...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GripmockSdk.StubHeadersAnyOfElement();
  });
  ...
  describe('StubHeadersAnyOfElement', function() {
    it('should create an instance of StubHeadersAnyOfElement', function() {
      // uncomment below and update the code to test StubHeadersAnyOfElement
      //var instance = new GripmockSdk.StubHeadersAnyOfElement();
      //expect(instance).to.be.a(GripmockSdk.StubHeadersAnyOfElement);
    });
