...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GripmockSdk.InspectRequest();
  });
  ...
  describe('InspectRequest', function() {
    it('should create an instance of InspectRequest', function() {
      // uncomment below and update the code to test InspectRequest
      //var instance = new GripmockSdk.InspectRequest();
      //expect(instance).to.be.a(GripmockSdk.InspectRequest);
    });
