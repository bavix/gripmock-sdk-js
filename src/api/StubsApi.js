...
export default class StubsApi {
    ...
    */
     ...
     * @param {module:model/AddStubRequest} addStubRequest Create a new stub in the store
     ...
     * @param {Array.<String>} requestBody Delete stubs by their IDs
     ...
     * @param {module:model/SearchRequest} searchRequest Search criteria including service, method, headers and data to match against stubs
