    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('inputs')) {
                obj['inputs'] = ApiClient.convertToType(data['inputs'], [StubInput]);
            }
 ...
 * @member {Array.<module:model/StubInput>} inputs
 */
Stub.prototype['inputs'] = undefined;
