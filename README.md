...
var api = new GripmockSdk.DescriptorsApi()
var body = "/path/to/file"; // {File} 
api.addDescriptors(body).then(function(data) {
...
*GripmockSdk.McpApi* | [**mcpInfo**](docs/McpApi.md#mcpInfo) | **GET** /mcp | MCP transport metadata
*GripmockSdk.McpApi* | [**mcpMessage**](docs/McpApi.md#mcpMessage) | **POST** /mcp | MCP JSON-RPC endpoint
...
## Documentation for Models
 ...
 - [GripmockSdk.McpError](docs/McpError.md)
 - [GripmockSdk.McpID](docs/McpID.md)
 - [GripmockSdk.McpInfoResponse](docs/McpInfoResponse.md)
 - [GripmockSdk.McpRequest](docs/McpRequest.md)
 - [GripmockSdk.McpResponse](docs/McpResponse.md)
 - [GripmockSdk.McpTool](docs/McpTool.md)
 - [GripmockSdk.McpTransport](docs/McpTransport.md)
